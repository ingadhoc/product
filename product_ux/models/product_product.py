...
<<<<<<< 9d4817a2457b681fdc0fdbec4876dbdcaed9a682
||||||| f3e973ca111f41959f69d29bf8e25418de4d42a9
from odoo.tools import create_index
=======
from odoo.modules.db import FunctionStatus
from odoo.tools import create_index
>>>>>>> c76589ee252e1f2c5578095d32dc2c2ac8e7f454
...
=======
    ...
    def _create_default_code_trigram_index(self):
        ...
        # Los dos avisos van en info y no en warning a proposito: una linea
        # WARNING durante el install alcanza para que runbot marque el build en
        # rojo (_check_warning en runbot/models/build_config.py), y abstenerse
        # no es una anomalia sino un estado esperable de la base.
