...
class pos_order(models.Model):
    ...
    def create_picking(self):
        ...
        for order in self:
            # if not order.lines.filtered(lambda l: l.product_id.type != 'service' and not l.product_id.pack):
            #     continue
            ...
            ''' --------- Add pack lines ------------'''
            for line in order.lines.filtered(lambda l: l.product_id.pack and l.product_id.pack_line_ids):
        ...
        # super(pos_order, self).create_picking(context=context)
        return True
